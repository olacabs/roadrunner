 ...
 */
public class ColumnFilterLongUniqueImpl implements ColumnFilterLong {
	
	String fieldName;
	long[][] columnDataArray;
	BitSetExposed[] nullStripArray;
	BitSetExposed[] availablePosBitSets;
	BitsetCache bitsCache;
	
	public ColumnFilterLongUniqueImpl(String fieldName, long[][] columnDataArray, BitSetExposed[] nullStripArray, BitSetExposed[] availablePosBitSets, BitsetCache bitsCache) {
		super();
	...
	private final void callBackGreaterThan(final long[] dataArray, final BitSetExposed intermediateBits, final long value) {
	...
	private final int operateGreaterThan(final long[] dataArray, final BitSetExposed intermediateBits, final int recordsT, int recordI, final long word, 
			final int bitStartIndex, final int bitEndIndex, final int recordsMaxCapacity, final long value) {
	...
	private final void callBackGreaterThanEqualTo(final long[] dataArray, final BitSetExposed intermediateBits, final long value) {
		int recordsMaxCapacity = dataArray.length;
	...
	private final int operateGreaterThanEqualTo(final long[] dataArray, final BitSetExposed intermediateBits, final int recordsT, int recordI, final long word, 
			final int bitStartIndex, final int bitEndIndex, final int recordsMaxCapacity, final long value) {
	...
	private final void callBackLesserThan(final long[] dataArray, final BitSetExposed intermediateBits, final long value) {
		int recordsMaxCapacity = dataArray.length;
	...
	private final int operateLesserThan(final long[] dataArray, final BitSetExposed intermediateBits, final int recordsT, int recordI, final long word, 
			final int bitStartIndex, final int bitEndIndex, final int recordsMaxCapacity, final long value) {
	...
	private final void callBackLesserThanEqualTo(final long[] dataArray, final BitSetExposed intermediateBits, final long value) {
		int recordsMaxCapacity = dataArray.length;
	...
	private final int operateLesserThanEqualTo(final long[] dataArray, final BitSetExposed intermediateBits, final int recordsT, int recordI, final long word, 
			final int bitStartIndex, final int bitEndIndex, final int recordsMaxCapacity, final long value) {
	...
	private final void callBackEqualTo(final long[] dataArray, final BitSetExposed intermediateBits, final long value) {
		int recordsMaxCapacity = dataArray.length;
	...
	private final int operateEqualTo(final long[] dataArray, final BitSetExposed intermediateBits, final int recordsT, int recordI, final long word, 
			final int bitStartIndex, final int bitEndIndex, final int recordsMaxCapacity, final long value) {
	...
	private final void callBackEqualTo(final long[] dataArray, final BitSetExposed intermediateBits, final long[] values) {
		int recordsMaxCapacity = dataArray.length;
	...
	private final int operateEqualTo(final long[] dataArray, final BitSetExposed intermediateBits, final int recordsT, int recordI, final long word, 
			final int bitStartIndex, final int bitEndIndex, final int recordsMaxCapacity, final long[] values) {
		
		for (int bitIndex = bitStartIndex; bitIndex < bitEndIndex; bitIndex++) {
			boolean bitVal = ((word & (1L << bitIndex)) != 0);
			if (bitVal) {
				long storedVal = dataArray[bitIndex];
	...
	private final void callBackRange(final long[] dataArray, final BitSetExposed intermediateBits, final long minValue, final long maxValue) {
	...
	private final int operateRange(final long[] dataArray, final BitSetExposed intermediateBits, final int recordsT, int recordI, final long word, 
			final int bitStartIndex, final int bitEndIndex, final int recordsMaxCapacity, final long minValue, final long maxValue) {
	...
	public final RecordIndexes opwork(final Operation operation, final long... values) {
		...
		for ( int i=0; i < length; i++) {
			...
			if(bs.nextSetBit(0) >= 0) {
				long[] dataArray = columnDataArray[i];
				switch (operation) {
				case GREATER_THAN:
